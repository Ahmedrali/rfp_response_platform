...
@router.post(
    ...
    description="Upload a PDF or DOCX document for processing. Maximum file size: 10MB."
)
async def upload_document(
    ...
    """
    Upload a document for the specified company.
    
    - **company_id**: UUID of the company
    - **file**: Document file to upload (PDF, DOCX, DOC formats, max 10MB)
    
    Returns document ID, filename, and initial status.
    """
